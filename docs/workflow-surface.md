...
- **Routing:** Use **Coach_me before Client Needs Intake** when the agent asks how to recommend, judge, or handle insurance/product recommendation. Client Needs Intake follows once direction/risk/action-source are clear.

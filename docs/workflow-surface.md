...
- **Routing:** Use the standalone **coach_me** skill before Insurance Copilot's domain workflow. Use **Coach_me before Client Needs Intake** when the agent asks how to recommend, judge, or handle insurance/product recommendation.
...
- **Output:** **Coach_me Working Document** and, when ready, an insurance handoff using `skills/insurance_copilot/templates/coach_me.md`. Treat **Q&A intake is raw source input**.

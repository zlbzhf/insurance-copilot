...
The **Coach_me Guided Reasoning Mode** eval protects one guided reasoning workflow for broad, messy, strategic, document-dependent, or customer-situation questions: **one workflow, not two skills**, **source discovery order**, **ask exactly three most precise and relevant questions**, **answer now or continue questioning**, **automatically stop questioning when information is sufficient**, **Coach_me Working Document**, **public institution knowledge**, **agent-private workspace**, **customer-specific materials**, **Q&A intake is raw source input**, **Karpathy-style LLM wiki backfeed proposal**, **no automatic persistence**, **Source Grounding and Data Boundary Gate**, and **Professional Review Gate** behavior.
